...
class Parser
{
    ...
    Declaration parseDeclaration(bool strict = false)
    {
        ...
        case tok!"alias":
            ...
            break;
        case tok!"class":
            mixin (nullCheck!`node.classDeclaration = parseClassDeclaration(node.attributes)`);
            break;
        case tok!"this":
        ...
        case tok!"static":
            ...
            break;
        case tok!"struct":
            mixin (nullCheck!`node.structDeclaration = parseStructDeclaration(node.attributes)`);
            break;
        case tok!"template":
